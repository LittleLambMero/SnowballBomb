...
execute as @e[type = minecraft:snowball] store result score @s TempScoreboard run data get entity @s Motion[0] 1000.0
...
execute as @e[type = minecraft:snowball] store result entity @s Motion[0] double 0.001 run scoreboard players get @s TempScoreboard
