...
execute if entity @s[tag = XOutOfBound] positioned ~-21 ~ ~1 run function snow_bomb:main/action_events/bomb_effects/mahapadma_bomb/extinguish/spawn_marker/loop
...
execute if entity @s[tag = ZOutOfBound] positioned ~ ~1 ~-21 run function snow_bomb:main/action_events/bomb_effects/mahapadma_bomb/extinguish/spawn_marker/loop
