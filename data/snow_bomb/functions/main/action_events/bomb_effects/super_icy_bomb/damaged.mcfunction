...
execute if entity @s[tag = BurningDamage] run function snow_bomb:main/action_events/bomb_effects/super_icy_bomb/damaged/burned_entity
execute if entity @s[tag = BurningDamage_Player] run function snow_bomb:main/action_events/bomb_effects/super_icy_bomb/damaged/burned_player
execute if entity @s[tag = ExtraFreezeDamage] run function snow_bomb:main/action_events/bomb_effects/super_icy_bomb/damaged/fire_entity
execute if entity @s[tag = !FreezeInvalid, tag = GeneralDamage] run function snow_bomb:main/action_events/bomb_effects/super_icy_bomb/damaged/general

# 給予狀態效果 (除了免疫冰凍的生物)
execute as @s[tag = !FreezeInvalid] run function snow_bomb:main/action_events/bomb_effects/super_icy_bomb/damaged/debuff
