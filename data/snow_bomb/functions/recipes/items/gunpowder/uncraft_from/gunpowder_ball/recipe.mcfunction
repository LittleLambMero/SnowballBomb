...
# 檢查素材
execute if score @s Passed matches 1 store success score @s Passed run data get block ~ ~ ~ Items.[{id: "minecraft:firework_star", tag: {ItemID: "snowbomb:gunpowder_ball"}}]
